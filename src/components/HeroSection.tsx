...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-32 right-16 w-8 h-8 bg-primary-light/40 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute top-1/3 right-1/4 w-6 h-6 bg-accent-light/50 rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto font-medium leading-relaxed">
            Help us bridge the digital divide. Your contribution can light up a child's path to a future they never imagined.
          </p>
          ...
          {/* Impact Preview */}
          <div className="pt-12 animate-slide-up" style={{ animationDelay: '1.2s' }}>
            ...
            <div className="flex justify-center gap-8 md:gap-16 text-white">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-accent-light">500+</div>
                <div className="text-sm opacity-90">Children Connected</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary-light">50+</div>
                <div className="text-sm opacity-90">Schools Reached</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-accent-light">1000+</div>
