      ...
      <div className="bg-gradient-hero text-white py-16 px-4">
        <div className="container mx-auto text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            Join us in shaping Africa's future—one child, one laptop at a time.
          </h2>
          <p className="text-xl opacity-90 max-w-3xl mx-auto">
            Every device donated, every dollar contributed, every partnership formed creates ripples of change 
        ...
        <div className="container mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 space-y-2">
                ...
                <div className="flex gap-3">
                  <Button size="sm" variant="outline" className="bg-secondary-light/20 border-secondary-foreground/20">
                    LinkedIn
                  </Button>
                  <Button size="sm" variant="outline" className="bg-secondary-light/20 border-secondary-foreground/20">
                    Twitter
          ...
          <div className="border-t border-secondary-foreground/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-secondary-foreground/60 text-sm">
              © 2024 SkillSeed for All. Building futures through technology access.
            </p>
            <div className="flex gap-6 text-sm text-secondary-foreground/60">
              ...
              <a href="#" className="hover:text-secondary-foreground transition-colors">Impact Reports</a>
            </div>
          </div>
        </div>
      </div>
