    ...
    <section className="py-20 px-4 bg-gradient-subtle">
      <div className="container mx-auto">
        ...
        <div className="text-center mt-16 pt-16 border-t border-border">
          <Card className="p-8 bg-primary text-white shadow-elevated max-w-4xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">
              Ready to Light Up a Child's Future?
            </h3>
            <p className="text-lg mb-6 opacity-90">
              Every action you take creates a ripple of hope across Africa.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                variant="outline"
                size="lg"
                className="hidden bg-white/10 border-white/30 text-white hover:bg-white/20"
              >
